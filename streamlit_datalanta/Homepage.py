...
st.image("streamlit_datalanta/jose-martin-ramirez-carrasco-yhNVwsKTSaI-unsplash.jpg",
...
st.image("streamlit_datalanta/de-andre-bush-eoohqHDVEP0-unsplash.jpg", use_column_width=True)
...
st.image("streamlit_datalanta/patrick-tomasso-14FtF6S_MpI-unsplash.jpg", use_column_width=True)
