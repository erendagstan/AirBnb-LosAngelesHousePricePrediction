...
@st.cache_data
def load_data():
    df_houses = pd.read_csv("DatalantaProject/streamlit_datalanta/datasets/airbnb-listings.csv", sep=";",
                            low_memory=False)
    df_fire_stations = pd.read_csv("DatalantaProject/streamlit_datalanta/datasets/Fire_Stations-new.csv",
                                   low_memory=False)
    df_police_station = pd.read_csv("DatalantaProject/streamlit_datalanta/datasets/Sheriff_and_Police_Stations.csv",
                                    low_memory=False)
    df_hosp2 = pd.read_csv("DatalantaProject/streamlit_datalanta/datasets/Hospitals_and_Medical_Centers.csv",
                           low_memory=False)
    df_school = pd.read_csv("DatalantaProject/streamlit_datalanta/datasets/Schools_Colleges_and_Universities.csv",
                            low_memory=False)
    metro_df = pd.read_csv("DatalantaProject/streamlit_datalanta/datasets/Metro_Rail_Lines_Stops.csv", low_memory=False)
    df_arrest = pd.read_csv("DatalantaProject/streamlit_datalanta/datasets/arrests_2017.csv",
    ...
    df_coffee = pd.read_csv("DatalantaProject/streamlit_datalanta/datasets/la_coffees_filtered.csv", low_memory=False)
